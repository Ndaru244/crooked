        ...
        <div class="col-12">
          <div class="col-12">
            <div class="callout callout-warning bg-warning">
              ...
              Sebelum menghapus data produk pastikan gambar di detail produk sudah terhapus semua
            </div>
          </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="row">
                          ...
                          <div class="col-sm">
                            <a href="<?= base_url('admin/product/edit/' . $get->id_product) ?>" class="btn btn-block btn-sm btn-success mb-1">Edit</a>
                          </div>
                          <div class="col-sm">
                            <a href="<?= base_url('admin/product/delete/' . $get->id_product) ?>" onclick="return confirm('anda yakin ingin menghapus data product <?= $get->product_name	 ?> ?')" class="btn btn-block btn-sm btn-danger">Hapus</a>
                          </div>
                        </div>
                      </td>
                    </tr>
