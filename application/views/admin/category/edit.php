...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><i class="fas fa-boxes"></i> <b>Edit Kategori</b></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <?= form_open('admin/category/edit/' . $datas->id_category) ?>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><b>Form Edit Kategori</b></h3>
                        </div>
                        <div class="card-body">
                            <div class="form-group">
                                <label for="">Nama Kategori</label>
                                <input type="text" name="category_name" value="<?= $datas->category_name ?>" class="form-control" placeholder="Nama Kategori">
                            </div>
                        </div>
